...
Candidate submission is explicit in v1. The workspace includes a Codesheep
code-server activity-bar extension that asks for candidate notes and submits the
assessment from the editor UI. `codesheep-submit` remains available as a terminal
